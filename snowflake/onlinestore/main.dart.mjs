...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1622: (x0,x1) => x0.getItem(x1),
      _1624: (x0,x1,x2) => x0.setItem(x1,x2),
      _1638: x0 => new Array(x0),
      _1640: x0 => x0.length,
      _1642: (x0,x1) => x0[x1],
      _1643: (x0,x1,x2) => x0[x1] = x2,
      _1646: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1648: x0 => new Int8Array(x0),
      _1649: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1650: x0 => new Uint8Array(x0),
      _1658: x0 => new Int32Array(x0),
      _1660: x0 => new Uint32Array(x0),
      _1662: x0 => new Float32Array(x0),
      ...
      _1696: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1697: () => new TextDecoder("utf-8", {fatal: true}),
      _1698: () => new TextDecoder("utf-8", {fatal: false}),
      ...
      _1821: o => Object.keys(o),
      _1822: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1823: (handle) => clearTimeout(handle),
      _1824: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1825: (handle) => clearInterval(handle),
      _1826: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1827: () => Date.now(),
      _1828: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1829: (x0,x1,x2) => x0.fetch(x1,x2),
      _1830: (x0,x1) => x0.get(x1),
      _1831: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1831(f,arguments.length,x0,x1,x2) }),
      _1832: (x0,x1) => x0.forEach(x1),
      _1833: x0 => x0.abort(),
      _1834: () => new AbortController(),
      _1835: x0 => x0.getReader(),
      _1836: x0 => x0.read(),
      _1837: x0 => x0.cancel(),
