...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1622: (x0,x1) => x0.replace(x1),
      _1623: (x0,x1) => x0.replace(x1),
      _1624: (x0,x1) => x0.replace(x1),
      _1625: (x0,x1) => x0.replace(x1),
      _1636: x0 => new Array(x0),
      _1638: x0 => x0.length,
      _1640: (x0,x1) => x0[x1],
      _1641: (x0,x1,x2) => x0[x1] = x2,
      _1644: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1646: x0 => new Int8Array(x0),
      _1647: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1648: x0 => new Uint8Array(x0),
      _1656: x0 => new Int32Array(x0),
      _1660: x0 => new Float32Array(x0),
      _1662: x0 => new Float64Array(x0),
      _1694: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1695: () => new TextDecoder("utf-8", {fatal: true}),
      _1696: () => new TextDecoder("utf-8", {fatal: false}),
      _1697: x0 => new WeakRef(x0),
      _1698: x0 => x0.deref(),
      _1704: Date.now,
      _1706: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1707: s => {
      ...
      _1709: () => typeof dartUseDateNowForTicks !== "undefined",
      _1710: () => 1000 * performance.now(),
      _1711: () => Date.now(),
      _1714: () => new WeakMap(),
      _1715: (map, o) => map.get(o),
      _1716: (map, o, v) => map.set(o, v),
      _1717: () => globalThis.WeakRef,
      _1728: s => JSON.stringify(s),
      _1729: s => printToConsole(s),
      _1730: a => a.join(''),
      _1733: (s, t) => s.split(t),
      ...
      _1737: s => s.trimLeft(),
      _1738: s => s.trimRight(),
      _1740: (s, p, i) => s.indexOf(p, i),
      _1741: (s, p, i) => s.lastIndexOf(p, i),
      _1743: Object.is,
      _1744: s => s.toUpperCase(),
      _1745: s => s.toLowerCase(),
      _1746: (a, i) => a.push(i),
      _1750: a => a.pop(),
      _1751: (a, i) => a.splice(i, 1),
      _1753: (a, s) => a.join(s),
      _1757: a => a.length,
      _1759: (a, i) => a[i],
      _1760: (a, i, v) => a[i] = v,
      _1763: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1764: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1765: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1766: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1767: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1768: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1769: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1771: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1772: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1773: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1774: (t, s) => t.set(s),
      ...
      _1864: x0 => x0.pop(),
      _1866: o => o === undefined,
      _1885: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1887: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1888: o => o instanceof RegExp,
      _1889: (l, r) => l === r,
      _1890: o => o,
      _1891: o => o,
      _1892: o => o,
      ...
      _1894: o => o.length,
      _1897: (o, i) => o[i],
      _1898: f => f.dartFunction,
      _1899: l => arrayFromDartList(Int8Array, l),
      _1900: l => arrayFromDartList(Uint8Array, l),
      _1901: l => arrayFromDartList(Uint8ClampedArray, l),
      _1902: l => arrayFromDartList(Int16Array, l),
      _1903: l => arrayFromDartList(Uint16Array, l),
      _1904: l => arrayFromDartList(Int32Array, l),
      _1905: l => arrayFromDartList(Uint32Array, l),
      _1906: l => arrayFromDartList(Float32Array, l),
      _1907: l => arrayFromDartList(Float64Array, l),
      _1908: x0 => new ArrayBuffer(x0),
      _1909: (data, length) => {
      ...
      _1910: l => arrayFromDartList(Array, l),
      _1911: () => ({}),
      _1912: () => [],
      _1913: l => new Array(l),
      _1914: () => globalThis,
      ...
      _1924: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
