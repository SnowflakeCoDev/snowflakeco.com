...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1821: () => Date.now(),
      _1822: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1823: (x0,x1) => globalThis.fetch(x0,x1),
      _1824: (x0,x1) => x0.get(x1),
      _1825: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1825(f,arguments.length,x0,x1,x2) }),
      _1826: (x0,x1) => x0.forEach(x1),
      _1827: x0 => x0.abort(),
      _1828: () => new AbortController(),
      _1829: x0 => x0.getReader(),
      _1830: x0 => x0.read(),
      _1831: x0 => x0.cancel(),
      _1866: (s, m) => {
        try {
      ...
      _1871: x0 => x0.pop(),
      _1873: o => o === undefined,
      _1892: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1894: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1895: o => o instanceof RegExp,
      _1896: (l, r) => l === r,
      _1897: o => o,
      _1898: o => o,
      _1899: o => o,
      ...
      _1901: o => o.length,
      _1904: (o, i) => o[i],
      _1905: f => f.dartFunction,
      _1906: l => arrayFromDartList(Int8Array, l),
      _1907: l => arrayFromDartList(Uint8Array, l),
      _1908: l => arrayFromDartList(Uint8ClampedArray, l),
      _1909: l => arrayFromDartList(Int16Array, l),
      _1910: l => arrayFromDartList(Uint16Array, l),
      _1911: l => arrayFromDartList(Int32Array, l),
      _1912: l => arrayFromDartList(Uint32Array, l),
      _1913: l => arrayFromDartList(Float32Array, l),
      _1914: l => arrayFromDartList(Float64Array, l),
      _1915: x0 => new ArrayBuffer(x0),
      _1916: (data, length) => {
      ...
      _1917: l => arrayFromDartList(Array, l),
      _1918: () => ({}),
      _1919: () => [],
      _1920: l => new Array(l),
      _1921: () => globalThis,
      ...
      _1944: x0 => x0.index,
      _1949: x0 => x0.flags,
      _1950: x0 => x0.multiline,
      _1951: x0 => x0.ignoreCase,
      _1952: x0 => x0.unicode,
      _1953: x0 => x0.dotAll,
      _1954: (x0,x1) => x0.lastIndex = x1,
      _1956: (o, p) => o[p],
      _1959: x0 => x0.random(),
      _1960: x0 => x0.random(),
      _1961: (x0,x1) => x0.getRandomValues(x1),
      _1962: () => globalThis.crypto,
      _1964: () => globalThis.Math,
      _1966: Function.prototype.call.bind(Number.prototype.toString),
      _1967: (d, digits) => d.toFixed(digits),
      _3902: () => globalThis.window,
      _3968: x0 => x0.navigator,
      _4359: x0 => x0.userAgent,
      _6606: x0 => x0.signal,
      _8510: x0 => x0.value,
      _8512: x0 => x0.done,
      _9235: x0 => x0.url,
      _9237: x0 => x0.status,
      _9239: x0 => x0.statusText,
      _9240: x0 => x0.headers,
      _9241: x0 => x0.body,
